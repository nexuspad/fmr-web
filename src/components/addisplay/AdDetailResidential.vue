      ...
      <div class="row pl-4 mt-4">
        <div class="col">
          <div class="container-fluid pl-0">
            <div class="row">
              <div class="col-md-7">
                <foreclosure-type :ad="ad" />
                <full-address :ad="ad" />
                <location-and-schools :ad="ad" />
                <property :ad="ad" />
                <pet-policy :ad="ad" v-if="isForRent(ad.categoryId)" />
              </div>
...
import ForeclosureType from './residential/ForeclosureType'
import FullAddress from './FullAddress'
import LocationAndSchools from './residential/LocationAndSchools'
import Contact from './Contact'
import Photos from './Photos'
import RentAndOffers from './residential/RentAndOffers'
import SalePrice from './residential/SalePrice'
...
export default {
  ...
  props: ['ad'],
  components: {
    RentAndOffers, SalePrice, ForeclosureType, FullAddress, LocationAndSchools, Property, PetPolicy, Features, Contact,
    Photos, BingMap
  }
}
</script>